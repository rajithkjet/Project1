...
public class AddInventry extends javax.swing.JFrame {
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        try {
            ...
            PreparedStatement p;
            p = std.prepareStatement("insert into inventry(itemID,ItemName,IStatus,DateRecived,Description,Username) values( '" + jTextField1.getText() + "','" + jTextField2.getText() + "','" + jTextField4.getText() + "','" + date + "','" + jTextArea1.getText() + "','" + User + "')   ");
