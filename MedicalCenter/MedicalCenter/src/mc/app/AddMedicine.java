    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
           try {
                Connection std = DAC.connect();
                 PreparedStatement p = std.prepareStatement("insert into medicine values( '"+jTextField1.getText()+"','"+jTextField2.getText()+"','"+jTextField3.getText()+"','"+jTextField8.getText()+"','"+jTextField6.getText()+"','"+jTextField5.getText()+"''"+jTextField4.getText()+"','"+jTextField7.getText()+"','"+User+"')   ");
