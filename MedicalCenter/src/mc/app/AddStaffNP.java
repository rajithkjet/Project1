 ...
 * @author Rajith
 */
public class AddStaffNP extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AddStaffNP.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
